...
[BakingType]
struct FlopplyBitChain2 : IBufferElementData
{
    public Entity Entity;
}

struct RootChainRoot2 : IComponentData
{
    public float Damping;
}

struct VertetNode2 : IComponentData
{
...
struct NodeConstraint2 : IComponentData
{
    public Entity Other;
    public float Length;
}

public class FlopplyBitMoreBaked : UnityEngine.MonoBehaviour
{
    public float Friction;

    class Baker : Baker<FlopplyBitMoreBaked>
    {
        public override void Bake(FlopplyBitMoreBaked authoring)
        {
